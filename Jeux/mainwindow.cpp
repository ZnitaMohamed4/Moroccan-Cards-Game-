...
MainWindow::MainWindow(QWidget *parent)
    : QMainWindow(parent)
{
    this->setStyleSheet("background-image: url(:/picture/bgg.jpg);"); // Set background image
    ...
    mon_image->setFixedSize(1000, 500);
    mon_image->setStyleSheet("background-image: url(:/picture/background_interface.jpg);");

    mon_container->addWidget(mon_text, 0, Qt::AlignCenter);
    mon_container->addSpacing(20);
    ...
    connect(bouton_quitter, &QPushButton::clicked, this, &MainWindow::close);
